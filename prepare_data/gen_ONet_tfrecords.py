...
def args():
    ...
    parser.add_argument('--read_type',type=str,\
...
def run(dataset_dir, net, output_dir, name='MTCNN', shuffling=False):
    ...
    dataset = get_dataset(dataset_dir, rd_type,net=net)
...
def get_dataset(dir,read_type=None, net='PNet'):
...
if __name__ == '__main__':
    dir = '.' 
    net = '48'
    output_directory = 'bright_imglists/ONet'
