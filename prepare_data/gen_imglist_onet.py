...
def args():
    ...
    parser.add_argument('--data_dir',type=str,default="./24",\
    ...
    parser.add_argument('--pos_txt',type=str,default="pos_24.txt",\
                        help='positive images annotion file ')
    parser.add_argument('--neg_txt',type=str,default="neg_24.txt",\
                        help='negtive images annotion file ')
    parser.add_argument('--part_txt',type=str,default="part_24.txt",\
                        help='part images annotion file ')
